...
function generateCast() {
    newCastObject.post(route("admin.cast.store"));
}
</script>
            ...
            <div class="mx-auto max-w-8xl sm:px-6 lg:px-8">
                <section class="container p-6 mx-auto font-mono">
                    <div class="flex justify-end w-full p-2 mb-4">
                        <form
                            class="p-2 m-2 space-x-4 bg-white rounded-md shadow"
                            @submit.prevent="generateCast"
                        >
                            <div class="flex">
                                <div class="flex items-center p-1">
                                    ...
                                    <div class="relative rounded-md shadow-sm">
                                        <input
                                            v-model="newCastObject.tmdb_id"
                                            id="tmdb_id_g"
                                            name="tmdb_id_g"
                                            class="px-3 py-2 border border-gray-300 rounded"
                                            placeholder="Cast TMDB ID"
                                        />
                                    </div>
                                </div>
                                <div class="p-1">
                            ...
                            <div
                                class="block my-1 text-sm text-red-500"
                                v-if="newCastObject.errors.tmdb_id"
                                v-text="newCastObject.errors.tmdb_id"
                            ></div>
                        </form>
                    </div>
                        ...
                        <div class="w-full p-5 bg-white shadow">
                            <div class="relative">
                                ...
                                <input
                                    v-model="search"
                                    type="text"
                                    placeholder="Search by cast name"
                            ...
                            <table class="w-full">
                                ...
                                <tbody class="bg-white">
                                    ...
                                    >
                                        ...
                                        <td
                                            class="px-4 py-3 font-semibold border"
                                        >
                                            {{ cast.slug }}
                                        </td>
